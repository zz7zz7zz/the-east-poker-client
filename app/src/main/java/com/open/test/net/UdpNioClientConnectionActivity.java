...
public class UdpNioClientConnectionActivity extends Activity {

	private static final String TAG = "UdpNioClient";
	...
	private IConnectListener mConnectResultListener = new IConnectListener() {
		...
		public void onConnectionSuccess(AbstractClient abstractClient) {
			...
			byte[] requestData = LoginClient.requestLogin("1113",0);
